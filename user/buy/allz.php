        ...
        <div class="posts col-10">
            ...
            <div class="row phone">
                <div class="row title-table">
                    <h2>Ваши заказы</h2>
                    <div class="red col-3">Категория</div>
                    <div class="red col-1">Цена</div>
                ...
                <?php foreach ($db_zak as $key => $value) : ?>
                    <div class="row post">
                        <?php $onecategor=selectOne('category',['category_id'=>$value['category_id']]); ?>
                        <div class="title col-2"><?= $onecategor['name']; ?></div>
                        <div class="title col-2"><?= $onecategor['price']; ?></div>
                        <div class="theme col-2"><?= $value['theme']; ?></div>
                        <div class="theme col-2"><?= $value['order_date']; ?></div>  
