                ...
                <div class="row add-post">
                    ...
                    <div class="mb-3 col-12 col-md-4 err">
                        ...
                        <div class="col">
                            ...
                            <input name="poid" value="<?= $poemsid; ?>" type="hidden">
                        </div>

                        <div class="col">
                            <label for="customRange3" class="form-label">Название</label>
                            <input name="name_poem" value="<?= $name ?>" type="text" class="form-control" placeholder="Title" aria-label="Название стиха">
                        </div>

                        <div class="col">
                            <label for="content" class="form-label">Текст</label>
                            <textarea name="textpoem" class="form-control" id="content" rows="3"><?= $text_poem ?></textarea>
                        </div>

                        <div class="col">
                            <label for="customRange3" class="form-label">ID пользователя</label>
                            <input name="id_user" value="<?= $id_user ?>" type="text" class="form-control" placeholder="ID пользователя" aria-label="">
                        </div>


                        <div class="col">
                            <label for="customRange3" class="form-label">Тема</label>
                            <input name="theme_poem" value="<?= $theme_poem ?>" type="text" class="form-control" placeholder="Тема" aria-label="">
                        </div>
                        ...
                        <div class="col">
                            <button name="poem-edit" class="btn btn-primary" type="submit">Обновить стихотворение</button>
                        </div>
                    </form>
                </div>
