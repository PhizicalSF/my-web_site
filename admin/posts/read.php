    ...
    <?php include("../../app/include/sidebar_admin.php"); ?>
            ...
            <div class="posts col-10">
                ...
                <div class="row title-table">
                    ...
                    <div class="text_poem col-3">Текст</div>
                    <div class="text_poem col-4">Управление</div>
                </div>
           
                <?php foreach ($db_poem_text as $key => $value) : ?>
                    <?php $topicsAUT = selectone('poems', ['poemsid' => $value['poemsid']]); ?>
                <div class="row post">
                    <div class="id col-1"><?= $value['poemsid']; ?></div>
                    <div class="title col-3"><?= $topicsAUT['name']; ?></div>
                    <div class="text_poem col-3"><?= $value['poem']; ?></div>
                    <div class="read col-2"><a href="read.php?poemsid=<?= $value['poemsid'] ?>">Читать</a></div>
                    <div class="red col-1"><a href="edit.php?poemsid=<?= $value['poemsid'] ?>">edit</a></div>
                    <div class="del col-2"><a href="edit.php?del_poem_id=<?= $value['poemsid'] ?>">delete</a></div>
                </div>
   <?php endforeach; ?>
                </div>
            </div>
