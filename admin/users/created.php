                    ...
                    <div class="row add-post">
                        ...
                        <div class="mb-3 col-12 col-md-4 err">
                           <?php include("../../app/helps/errorinfo.php"); ?>
                            ...
                            <select name="admin_status" class="form-select" aria-label="Default select example">
                            ...
                            <div class="col">
                                <button name="users_button"class="btn btn-primary" type="submit">Сохранить</button>
                            </div>
                        </form>
                    </div>
