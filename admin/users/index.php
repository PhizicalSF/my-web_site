            ...
            <div class="posts col-10">
                ...
                <div class="row phone">
                    <div class="row title-table">
                        ...
                        <div class="name col-3">Имя</div>
                        <div class="mail col-3">Email</div>
                        <div class="rol col-1">Роль</div>
                    ...
                    <div class="row post">
                        ...
                        <div class="mail col-3"><?= $value['email']; ?></div>
                        
                        <div class="admin_s col-1"><?= $value['admin_status']; ?></div>         
